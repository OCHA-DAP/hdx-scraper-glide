# Collector for Glide Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-glide/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-glide/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-glide/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-glide?branch=main)
 ...
 **hdx-scraper-glide** as specified in the parameter
 *user_agent_lookup*.
